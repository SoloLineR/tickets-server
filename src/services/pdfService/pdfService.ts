...
class PDFService {
  async generatePDF(callbackData, callbackEnd) {
    const img =
    ...
    pdfDoc.fontSize(12).text("The International 2024", 130, 170);
    pdfDoc.fontSize(12).text("Email: wvS0h@example.com", 130, 200);
